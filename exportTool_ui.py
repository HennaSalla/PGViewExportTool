...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.testConnectionPushButton.setGeometry(QRect(10, 220, 101, 24))
...
"color: rgb(255, 255, 255);")
        ...
        self.widget.setGeometry(QRect(10, 10, 361, 191))
        ...
        self.batabaseLineEdit = QLineEdit(self.widget)
        self.batabaseLineEdit.setObjectName(u"batabaseLineEdit")

        self.gridLayout.addWidget(self.batabaseLineEdit, 2, 1, 1, 1)
        ...
        self.viewNameLabel.setGeometry(QRect(30, 300, 91, 16))
        self.exportPushButton = QPushButton(self.centralwidget)
        self.exportPushButton.setObjectName(u"exportPushButton")
        self.exportPushButton.setGeometry(QRect(410, 320, 111, 24))
        self.exportPushButton.setStyleSheet(u"background-color: rgb(85, 170, 127);\n"
"color: rgb(255, 255, 255);")
        self.previweTableWidget = QTableWidget(self.centralwidget)
        self.previweTableWidget.setObjectName(u"previweTableWidget")
        self.previweTableWidget.setGeometry(QRect(0, 370, 711, 251))
        self.getDataPushButton = QPushButton(self.centralwidget)
        self.getDataPushButton.setObjectName(u"getDataPushButton")
        self.getDataPushButton.setGeometry(QRect(320, 320, 71, 24))
...
"color: rgb(255, 255, 255);")
        ...
        self.previewLabel.setGeometry(QRect(30, 350, 61, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dbSettingsLabel.setText(QCoreApplication.translate("MainWindow", u"Tietokantayhrteyden asetukset", None))
        ...
        self.portLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"TCP-portin numero, oletus", None))
        self.databaseLabel.setText(QCoreApplication.translate("MainWindow", u"Tietokanta", None))
        self.batabaseLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Tietokannan nimi, hallintatietokanta postgres", None))
